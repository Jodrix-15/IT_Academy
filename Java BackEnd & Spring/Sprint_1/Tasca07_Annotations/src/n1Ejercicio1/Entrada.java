...
public class Entrada extends Exception{
	...
	public byte llegirByte(String msj) throws InputMismatchException {
		Object num;
		byte numCorrecto;
	...
	public int llegirInt(String msj) throws InputMismatchException{
		Object obj;
		int num;
	...
	public float llegirFloat(String msj) throws InputMismatchException{
		Object obj;
		float num;
	...
	public double llegirDouble(String msj) throws InputMismatchException{
		Object obj;
		double num;
	...
	public char llegirChar(String msj) throws Exception {
		Object obj;
		char ch;
	...
	public String llegirString(String msj) {
	...
	public boolean llegirSiNo(String msj) throws Exception{
		/*si l’usuari/ària introdueix “s”, retorna “true”, si 
		l’usuari introdueix “n”, retorna “false”.*/
